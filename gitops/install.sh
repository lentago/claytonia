...
#
#   curl -fsSL https://raw.githubusercontent.com/PitziLabs/bullpen/main/gitops/install.sh | bash
#   (or run from a checkout)
set -euo pipefail
REPO_URL="${BULLPEN_REPO_URL:-https://github.com/PitziLabs/bullpen.git}"
